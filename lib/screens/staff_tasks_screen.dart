...
class _StaffTasksScreenState extends State<StaffTasksScreen> {
  final List<Map<String, dynamic>> _tasks = [
    {
      "id": "T001",
      "title": "Fix electricity in Apt 12",
      "location": "Building A - Floor 3",
      "priority": "High",
      "status": "pending",
      "resident": "Ahmed Ben Ali",
    },
    {
      "id": "T002",
      "title": "Plumbing issue in Apt 7",
      "location": "Building B - Floor 1",
      "priority": "Medium",
      "status": "in_progress",
      "resident": "Sara Mansouri",
    },
    {
      "id": "T003",
      "title": "AC not working in Apt 25",
      "location": "Building A - Floor 5",
      "priority": "Low",
      "status": "completed",
      "resident": "Karim Bouzid",
    },
    {
      "id": "T004",
      "title": "Broken window in Apt 3",
      "location": "Building C - Floor 1",
      "priority": "High",
      "status": "pending",
      "resident": "Fatima Zerrouk",
    },
  ];
